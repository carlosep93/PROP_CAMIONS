...
public class VistaDialogo {
	...
	public int setDialogo(String strTitulo, String strTexto,
			String[] strBotones, int iTipo) {
		...
		JDialog dialogOptionPane = optionPane.createDialog(new JFrame(),
				strTitulo);
		...
		int isel;
		for (isel = 0; isel < strBotones.length
				&& !strBotones[isel].equals(vsel); isel++)
			;
		return isel;
	}
