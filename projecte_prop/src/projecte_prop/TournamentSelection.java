...
public class TournamentSelection {
    ...
    */
    public static Tour tournamentSelection(Ciutat C, CjtTours pop, int tournamentSize){
        int Fitness= 0;
    ...
    */
    public static Tour tournamentSelection_roulettewheel(Ciutat C, CjtTours pop){
